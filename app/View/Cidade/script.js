...
$(document).ready(function() {
    ...
    $("body").on("click", ".teste", function() {
        ...
        $.ajax({
            ...
            success: function(result, status, xhr) {
                if (result.success) {
                    $("#conteudo").html('<div class="row"> <div class="col-1"> <i class="fas fa-info-circle"></i> </div><div class="col-10"> <p>' + result.data.descricao + '</p></div></div><div class="row"><div class="col-1"><i class="fas fa-hand-holding-usd"></i> </div><div class="col-10"> <p>' + result.data.formaPagamento + '</p></div></div><div class="row"> <div class="col-1"> <i class="fas fa-truck"></i> </div><div class="col-10"> <p>' + result.data.formaEntrega + '</p></div></div>');
                }
                console.log(result);
            },
            error: function(xhr, status, errorMessage) {
